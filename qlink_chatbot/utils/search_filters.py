"""
SearchFilters dataclass + constants + parser helpers for the product search layer.
Consumed by search_middleware.py (entry point) and search_mongo.py (DB internals).
"""
import re
